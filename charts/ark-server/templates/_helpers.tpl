...
helm.sh/chart: {{ include "ark-server.chart" . }}
{{ include "ark-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "ark-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ark-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
